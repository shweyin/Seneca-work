...
namespace sict
{
	...
	Hero::Hero(char * con_name, int con_health, int con_strength)
	{
	...
	{
		return (strcmp(name, "") == 0 && health == -1 && strength == -1);
	}
	bool Hero::valid(char * unvalidated_name, int unvalidated_health, int unvalidated_strength)
	{
