...
{
    imageDisplay = document.querySelector("#imagePage");
    imageTxt = "";
    for (var i = 0; i < images.length; i++)
    {
        imageTxt += "<figure>" + "<img src =" + images[i].url +  "alt =" + images[i].alt + "title =" + images[i].caption + "/>" + "<figcaption>" + images[i].caption + "</figcaption>" + "</figure>";
    }
    imageDisplay.innerHTML = imageTxt;
}